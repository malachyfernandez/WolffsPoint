...
const ArchivedGameRow = ({ gameId, index, onUnarchive, textClassName }: ArchivedGameRowProps) => {
  ...
  return (
    <Row className="items-center gap-0">
      <View className="h-16! flex-1" style={{ pointerEvents: 'none' }}>
        <ListRow
          className={`pointer-events-none flex-1 items-center justify-between ${borderClass}`}>
      ...
      <AppButton variant="filled" className="h-10 px-3" onPress={onUnarchive}>

...
const UserEditDialog = ({
  ...
  const UNDOABLEsetUserTable = (updatedUsers: UserTableItem[]) => {
    const previousUserTable = createUndoSnapshot(users);
    ...
    <>
      <ConvexDialog.Root isOpen={isOpen} onOpenChange={handleDialogOpenChange}>
        <ConvexDialog.Trigger asChild>
          <View>{/* This will be replaced by the actual pressable in UserRow */}</View>
        ...
        <ConvexDialog.Portal>
          ...
          <ConvexDialog.Content className="max-w-xl">
            ...
            <DialogHeader text={`Edit User`} subtext={`Set the user details`} />
              ...
              <Column className="w-full items-center justify-center gap-4">
                <Column className="w-min gap-4">
                  <Row className="w-min max-w-full gap-4">
                    ...
                    <AppButton
                      className="w-22 h-10 max-w-[30vw] sm:w-48"
                      variant="outline"

    ...
    <>
      <TownSquareMoreOptionsDialog
        ...
        onSelectAction={(action) =>
          runBodyUpdate((value, range) => applyMoreComposerAction(value, range, action))
        }
      />
      ...
      <TownSquareLinkDialog
        ...
        onInsert={(label, url) =>
          runBodyUpdate((value, range) => insertMarkdownLink(value, range, label, url))
        }
      ...
      <InputOptionsProvider gameId={gameId} showInputs={showInputs}>
        <MarkdownInputBuilderDialog
          ...
          onInsert={(scriptBlock) =>
            runBodyUpdate((value, range) =>
              insertAtSelection(value, range, `\n\n${scriptBlock}\n\n`)
            )
          }

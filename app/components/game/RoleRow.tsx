    ...
    return (
        <>
            <Row className={`gap-0 h-12 w-min ${isEditing ? 'z-50' : ''}`}>
                <Column className={`gap-4 w-32 h-full border border-subtle-border items-center justify-center ${isLast ? 'rounded-bl-lg' : ''}`}>
                    <InlineEditableText
                        value={role.role || ''}
                ...
                <Column className='gap-4 w-24 h-full border border-subtle-border items-center justify-center'>
                    <CustomCheckbox checked={role.doesRoleVote} onChange={toggleDoesRoleVote} selectedStateAppearance='positive' />
                </Column>
                <Column className={`gap-4 w-64 h-full border border-subtle-border items-center justify-center`}>
                ...
                <Column className={`gap-4 w-64 h-full border border-subtle-border items-center justify-center ${isLast ? 'rounded-br-lg' : ''}`}>
